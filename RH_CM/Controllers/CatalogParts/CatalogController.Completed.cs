...
namespace RH_CM.Controllers
{
    public partial class CatalogController
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View("Completed/Index", lista);
        }
        ...
        public async Task<IActionResult> IndexCourseCompleted()
        {
            ...
            return View("Completed/IndexCourseCompleted", rows);
        }
        ...
        /// so staff can cross-check the data behind the Course Completed catalog.
        /// </summary>
        [Authorize(Policy = "ViewAccess")]
        ...
        public async Task<IActionResult> CreateCourseCompletedBulk(int? fkCourse, int? fkLevel)
        {
            ...
            return View("Completed/CreateCourseCompletedBulk");
        }
            ...
            bool allowUpsert = true)
        {
            ...
            {
                TempData["ErrorMessage"] = CourseCompletedMessages.SelectACourseALevelAndAt;
            ...
            {
                TempData["ErrorMessage"] = CourseCompletedMessages.AllSelectedPeopleAlreadyHaveTheCourse;
                return RedirectToAction(nameof(CreateCourseCompletedBulk), new { fkCourse = FkCourse, fkLevel = FkRequiredCourseLevels });
            }
            ...
            TempData["SuccessMessage"] = CourseCompletedMessages.RecordsCreatedUpdatedSuccessfully;
            return RedirectToAction(nameof(CreateCourseCompletedBulk), new { fkCourse = FkCourse, fkLevel = FkRequiredCourseLevels });
        }
        ...
        public async Task<IActionResult> DeleteCourseCompletedBulk(int? fkCourse, int? fkLevel)
        {
            ...
            return View("Completed/DeleteCourseCompletedBulk");
        }
        ...
        )
        {
            ...
            {
                TempData["ErrorMessage"] = CourseCompletedMessages.SelectAtLeastOneRecordToDelete;
            ...
            try
            {
                ...
                if (affected == 0)
                    TempData["ErrorMessage"] = CourseCompletedMessages.NoRecordsWereDeletedCheckYourSelection;
                else
                    TempData["SuccessMessage"] = string.Format(CourseCompletedMessages.OperationCompletedRowsAffectedFormat, affected);
            }
            catch (SqlException ex)
            {
                TempData["ErrorMessage"] = string.Format(CourseCompletedMessages.ErrorOccurredWhileBulkDeletingCompletedCoursesFormat, ex.Message);
            }
        ...
        public async Task<IActionResult> ToggleCourseCompleted(int id)
        {
            ...
            {
                TempData["ErrorMessage"] = CourseCompletedMessages.InvalidRecord;
        ...
        public async Task<IActionResult> DeleteCourseCompleted(int id)
        {
            ...
            if (item == null)
            {
                TempData["ErrorMessage"] = CourseCompletedMessages.RecordDoesNotExistOrHasAlready;
                return RedirectToAction(nameof(IndexCourseCompleted));
            }
            ...
            try
            {
                ...
                await _context.SaveChangesAsync();
                TempData["SuccessMessage"] = CourseCompletedMessages.RecordDeletedSuccessfully;
            }
            catch (DbUpdateException)
            {
                TempData["ErrorMessage"] = CourseCompletedMessages.RecordCannotBeDeletedBecauseOfRelated;
            }
