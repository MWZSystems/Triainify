...
namespace RH_CM.ViewModels
{
    public class CreateHeadCountViewModel
    {
        ...
        public string? Ntuser { get; set; } // Added for user creation during onboarding.

        [ValidateNever]
        public IEnumerable<CtDepartment> Departments { get; set; } = Enumerable.Empty<CtDepartment>();
        [ValidateNever]
        public IEnumerable<CtPosition> Position { get; set; } = Enumerable.Empty<CtPosition>();
        [ValidateNever]
        public IEnumerable<SupervisorDisplayViewModel> Supervisors { get; set; } = Enumerable.Empty<SupervisorDisplayViewModel>();
    }
}
